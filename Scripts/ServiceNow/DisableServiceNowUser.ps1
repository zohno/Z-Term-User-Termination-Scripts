...
Invoke-RestMethod -Credential $SNowCreds -Headers $headers -Body '{"active": "false"}' -Method Put -Uri ("https://" + $NowInstance + ".service-now.com/api/now/v1/table/sys_user/" + $SysUserId + "" | echo) -ContentType "application/json"
